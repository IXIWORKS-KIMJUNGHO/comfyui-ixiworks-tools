...
from .s3_nodes import (
    NODE_CLASS_MAPPINGS as S3_NODE_CLASS_MAPPINGS,
    NODE_DISPLAY_NAME_MAPPINGS as S3_NODE_DISPLAY_NAME_MAPPINGS,
)
...
NODE_CLASS_MAPPINGS = {
    ...
    **PROMPT_NODE_CLASS_MAPPINGS,      # IXIWORKS/Prompt
    **S3_NODE_CLASS_MAPPINGS,          # IXIWORKS/Utils (S3)
}
